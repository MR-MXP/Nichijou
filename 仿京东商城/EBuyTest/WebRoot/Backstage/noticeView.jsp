...
<%
	...
	Notice c = (Notice)request.getAttribute("notice");
 %>
<body>
<!--头部-->
...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerView">
            <p><strong>公告编号：</strong><span><%=c.getId()%></span></p>
            <p><strong>公告标题：</strong><span><%=c.getTitle()%></span></p>
            <p><strong>发布者    ：</strong><span><%=c.getUserName()%></span></p>
            <p><strong>发布时间：</strong><span><%=c.getCreateTime()%></span></p>
            <p><strong>公告内容：</strong><span>
            </span></p>
            <textarea style="margin-left: 200px;color:#bd644e; font-size:20px;margin-top: -25px;" rows="5" cols="60" readonly="readonly"><%=c.getText()%></textarea>
