...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerView">
            <p><strong>用户编号：</strong><span><%=c.getId() %></span></p>
            <p><strong>用户名称：</strong><span><%=c.getName()%></span></p>
            <p><strong>用户性别：</strong><span><%=c.getSex()%></span></p>
            <p><strong>用户邮箱：</strong><span><%=c.getEmail() %></span></p>
            <p><strong>用户电话：</strong><span><%=c.getMovePhone() %></span></p>
            <p><strong>用户地址：</strong><span><%=c.getAddres()%></span></p>
            <p><strong>用户类别：</strong><span><%=vip%></span></p>
			<p><strong>注册时间：</strong><span><%=c.getRegisterTime()%></span></p>
