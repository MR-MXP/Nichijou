        ...
        <div class="providerAdd">
            <form action="pList?op=addpro" method="post">
                ...
                <div>
                    ...
                    <input type="text" name="providerName" id="providerName" onblur="nameverify()"/>
                    <span >*请输入商品名称</span>
                    <span id="rname"></span>
                </div>
                <div>
                    <label for="Price">商品价格：</label>
                    <input type="text" name="providerPrice" id="providerPrice"/>
                    <span>*请输入商品价格</span>
					<span id="rpwd"></span>
                </div>
                <div>
