...
<%@page import="com.entity.GoodsCar"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="<%=path%>/home/AmazeUI-2.4.2/assets/css/amazeui.css" rel="stylesheet" type="text/css" />
		<link href="<%=path%>/home/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css" />

		<link href="<%=path%>/home/basic/css/demo.css" rel="stylesheet" type="text/css" />

		<link href="<%=path%>/home/css/hmstyle.css" rel="stylesheet" type="text/css" />
		<script src="<%=path%>/home/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
		<script src="<%=path%>/home/AmazeUI-2.4.2/assets/js/amazeui.min.js"></script>

	</head>
	<%
	PageUtil<Providers> pages = (PageUtil<Providers>)request.getAttribute("page");
	ArrayList<Providers> clist = pages.getListAll();
	PageUtil<Notice> npages = (PageUtil<Notice>)request.getAttribute("notice");
	ArrayList<Notice> nlist = npages.getListAll();
	PageUtil<Providers> shopTitle = (PageUtil<Providers>)request.getAttribute("shopTitle");
	ArrayList<Providers> slist = shopTitle.getListAll();
	//获取购物车
	GoodsCar car = (GoodsCar)session.getAttribute("car");
	int num = 0;
	if(car!=null){
		HashMap<Integer,GoodsInfo> c= car.getCar();
		num =  c.size();
	}
	//检查用户是否存在
	String username="请登录";
	...
	<body>
			...
			<div class="am-container header">
				...
				<ul class="message-r">
					...
					<div class="topMessage mini-cart">
						<div class="menu-hd"><a id="mc-menu-hd" href="homepage?op=showCar&name=<%=username%>" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
					</div>
				...
				<div class="nav white">
					<div class="logo"><img src="<%=path%>/home/images/logo.png" /></div>
					<div class="logoBig">
						<li><img src="<%=path%>/home/images/logobig.png" /></li>
					</div>
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.html"><img src="<%=path%>/home/images/ad1.jpg" /></a></li>
								<li class="banner2"><a><img src="<%=path%>/home/images/ad2.jpg" /></a></li>
								<li class="banner3"><a><img src="<%=path%>/home/images/ad3.jpg" /></a></li>
								<li class="banner4"><a><img src="<%=path%>/home/images/ad4.jpg" /></a></li>
			...
			<div class="shopNav">
				<div class="slideall">
										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
													<em>&gt;</em></div>
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative last">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="<%=path%>/home/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.html"><img src="<%=path%>/home/images/navsmall.jpg" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="<%=path%>/home/images/huismall.jpg" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="<%=path%>/home/images/mansmall.jpg" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="<%=path%>/home/images/moneysmall.jpg" />
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="<%=path%>/home/images/TJ2.jpg"></img>
									<span>[特惠]</span>商城爆品1分秒								
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[公告]</span>商城与广州市签署战略合作协议
								     <img src="<%=path%>/home/images/TJ.jpg"></img>
								     <p>XXXXXXXXXXXXXXXXXX</p>
							    </a></li>
							    
						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="<%=path%>/home/person/index.html">
									<img src="<%=path%>/home/images/getAvatar.do.jpg">
								</a>
								<em>
							...
							<div class="clear"></div>	
							   ...
							   <%
							   	if(nlist!=null){
							   		for(Notice n:nlist){
							    %>
								<li><a target="_blank" href="#"><span>[<%=n.getTitle() %>]</span><%=n.getText() %></a></li>
								<%
									}
								} 
								%>
							</ul>
                        <div class="advTip"><img src="<%=path%>/home/images/advTip.jpg"/></div>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						<div class="clock am-u-sm-3" ">
							<img src="<%=path%>/home/images/2016.png "></img>
							<p>今日<br>推荐</p>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain ">
								<img src="<%=path%>/home/images/tj.png "></img>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain ">
								<img src="<%=path%>/home/images/tj1.png "></img>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain ">
								<img src="<%=path%>/home/images/tj2.png "></img>
							</div>
						</div>
					...
					<div class="am-container activity ">
					  ...
					  <%
					   ...
					   %>
					   <a href="homepage?op=ViewProduct&id=<%=p.getGoodsId()%>">
					   	<div class="am-u-sm-3 ">
							<div class="icon-sale one "></div>	
								<h4>秒杀</h4>							
							<div class="activityMain ">
								<img src="<%=p.getPhoto()%>"></img>
							</div>
							<div class="info">
								<h3>春节送礼优选</h3>
							</div>														
					...
					<%
					Providers sone = slist.get(0);
					Providers stwo = slist.get(1);
					Providers sthree = slist.get(2);
					Providers sfour = slist.get(3);
					Providers sfive = slist.get(4);
					Providers ssix = slist.get(5);
					Providers sseven = slist.get(6);
					 %>
						<div class="am-u-sm-5 am-u-md-3 am-u-lg-4 text-one ">
							<a href="homepage?op=ViewProduct&id=<%=sone.getGoodsId()%>">
								<div class="outer-con ">
									<div class="title ">
										<%=sone.getGoosName() %>
									</div>					
						...
						<div class="am-u-sm-7 am-u-md-5 am-u-lg-4">
							<div class="text-two">
								...
								<a href="homepage?op=ViewProduct&id=<%=stwo.getGoodsId()%>"><img src="<%=stwo.getPhoto() %>" /></a>
							</div>
							<div class="text-two last">
								...
								<a href="homepage?op=ViewProduct&id=<%=sthree.getGoodsId()%>"><img src="<%=sthree.getPhoto() %>" /></a>
						    </div>
						</div>
		             <div class="am-u-sm-12 am-u-md-4 ">
						<div class="am-u-sm-3 am-u-md-6 text-three">
							...
							<a href="homepage?op=ViewProduct&id=<%=sfour.getGoodsId()%>"><img src="<%=sfour.getPhoto() %> " /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-6 text-three">
							...
							<a href="homepage?op=ViewProduct&id=<%=sfive.getGoodsId()%>"><img src="<%=sfive.getPhoto() %>" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-6 text-three">
							...
							<a href="homepage?op=ViewProduct&id=<%=ssix.getGoodsId()%>"><img src="<%=ssix.getPhoto() %>" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-6 text-three last ">
							...
							<a href="homepage?op=ViewProduct&id=<%=sseven.getGoodsId()%>"><img src="<%=sseven.getPhoto() %>" /></a>
						</div>
					</div>
					</div>
                 <div class="clear "></div>
					...
					<div class="am-g am-g-fixed floodTwo ">
						...
						<div class="am-u-sm-5 am-u-md-4 text-one ">
							<a href="# ">
								<img src="<%=path%>/home/images/act1.png " />
								<div class="outer-con ">
									<div class="title ">
										零食大礼包开抢啦
									</div>
						...
						<div class="am-u-sm-7 am-u-md-4 am-u-lg-2 text-two">
								...
								<a href="# "><img src="<%=path%>/home/images/5.jpg " /></a>						
						</div>
						...
						<div class="am-u-md-4 am-u-lg-2 text-three">
							...
							<a href="# "><img src="<%=path%>/home/images/act3.png " /></a>
						</div>
						<div class="am-u-md-4 am-u-lg-2 text-three">
							<div class="outer-con ">
								<div class="title ">
						...
						<div class="am-u-sm-4 am-u-md-3 am-u-lg-4 text-five">
							...
							<a href="# "><img src="<%=path%>/home/images/act2.png " /></a>
						</div>	
					...
					<div class="am-g am-g-fixed flood method3 ">
						<ul class="am-thumbnails ">
							<li>
								<div class="list ">
									<a href="# ">
										<img src="<%=path%>/home/images/cp.jpg " />
							...
							<li>
								<div class="list ">
									<a href="# ">
										<img src="<%=path%>/home/images/cp2.jpg " />
		...
		<div class="navCir">
			...
			<li><a href="homepage?op=showCar&name=<%=username%>"><i class="am-icon-shopping-basket"></i>购物车</a></li>	
			<li><a href="<%=path%>/home/person/index.html"><i class="am-icon-user"></i>我的</a></li>					
		</div>
		<!--菜单 -->
		<div class=tip>
			<div id="sidebar">
				<div id="wrap">
					<div id="prof" class="item ">
						...
						<div class="ibar_login_box status_login ">
							<div class="avatar_box ">
								<p class="avatar_imgbox "><img src="<%=path%>/home/images/no-img_mid_.jpg " /></p>
								<ul class="user_info ">
									<li>用户名：sl1903</li>
									<li>级&nbsp;别：普通会员</li>
								</ul>
					...
					<div id="shopCart " class="item ">
						<a href="homepage?op=showCar&name=<%=username%>">
					...
					<div id="brand " class="item ">
						<a href="#">
							<span class="wdsc "><img src="<%=path%>/home/images/wdsc.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我的收藏
							<i class="icon_arrow_right_black "></i>
					...
					<div id="broadcast " class="item ">
						<a href="# ">
							<span class="chongzhi "><img src="<%=path%>/home/images/chongzhi.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我要充值
							<i class="icon_arrow_right_black "></i>
					...
					<div class="quick_toggle ">
						...
						<li class="qtitem ">
							...
							<div class="mp_qrcode " style="display:none; "><img src="<%=path%>/home/images/weixin_code_145.png " /><i class="icon_arrow_white "></i></div>
						</li>
						<li class="qtitem ">
		...
		<script type="text/javascript " src="<%=path%>/home/basic/js/quick_links.js "></script>
	</body>
